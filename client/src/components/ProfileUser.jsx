        ...
        <div className={styles.mainBody}>
          <div className={`row gutters-sm ${styles.guttersSm}`}>
            ...
            <div className='col-md-8'>
              {isEditing ? <ProfileEditInfoUser changeForm={setEditing} /> : <ProfileShowInfoUser changeForm={setEditing} />}
              ...
              <div className='row gutters-sm'>
                  ...
                  <div className={`${styles.card} h-100`}>
                    <div className={`card-body ${styles.cardBody}`}>
                      <h6 className='d-flex align-items-center mb-3'>
                        <i className='fa fa-black-tie text-secondary' style={{ marginRight: '5px' }} aria-hidden='true'>
                          {' '}
                        </i>{' '}
                        MIS EMPLEADORES
                      </h6>
                ...
                <div className='col-sm-6 mb-3'>
                  <div className={`${styles.card} h-100`}>
                    <div className={`card-body ${styles.cardBody}`}>
                      <h6 className='d-flex align-items-center mb-3'>
                        <i className='fa fa-user text-secondary' style={{ marginRight: '5px' }} aria-hidden='true'>
                          {' '}
                        </i>{' '}
                        MIS CLIENTES
                      </h6>
